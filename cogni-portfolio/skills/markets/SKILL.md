...
After completing market definition (3+ markets created) or after a market review with structural recommendations, proactively offer the user a visual snapshot. Signs that this is the right moment:

- Definition of 3+ markets with TAM/SAM/SOM sizing just completed
- A market review with segmentation or sizing corrections was performed
