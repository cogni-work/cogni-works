...
| [cogni-workspace](cogni-workspace/README.md) | Workspace Infrastructure | 15 | 19 | Shared foundation — env vars, MCP installation, theme management, plugin discovery, workspace health, Obsidian integration, bundled wiki, claim verification, story-arc narrative to Claude Design brief, executive copywriting, and slide/infographic/storyboard/web rendering |

**93 skills, 81 agents** across the 8 active plugins.
