...
To use: during `/trends-catalog init`, when asked about taxonomy, reference the b2b-ict-portfolio
...
2. Check `cogni-trends/catalogs/{industry}/{subsector}/catalog.json`
...
- If a matching catalog exists, offer to run `/trends-catalog import` immediately
- If no catalog exists, suggest creating one with `/trends-catalog init`
