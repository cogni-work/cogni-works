...
When `language` is `de`, use these German headers instead of the English template defaults.

| English Template Header | German Header |
|------------------------|---------------|
...
| Proven Results | Nachgewiesene Ergebnisse |
