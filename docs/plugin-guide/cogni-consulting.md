...
| Plugin dispatch fails silently | The dispatched plugin is not installed in this workspace | Run `workspace-status` to check the plugin registry; install the missing plugin and run `update-workspace` |
