...
After completing a bridge operation (tips-to-portfolio, portfolio-to-tips, or sync), proactively offer the user a visual snapshot. Bridge operations are heavy — they create features, enrich propositions, generate evidence, and produce opportunity pipelines. Signs that this is the right moment:

- A tips-to-portfolio or sync operation completed with entity creation or enrichment
- The reconciliation table and action plan were presented
