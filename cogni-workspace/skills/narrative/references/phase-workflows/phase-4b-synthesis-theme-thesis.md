...
**This arc is designed for theme-level narratives within TIPS trend reports.** When invoked standalone via `cogni-workspace:narrative --arc-id theme-thesis`, the input should contain theme-structured content with:
