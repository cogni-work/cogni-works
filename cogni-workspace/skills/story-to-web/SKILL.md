...
**Read reference:** `$CLAUDE_PLUGIN_ROOT/libraries/web-section-architecture.md` (Arc-to-Section Mapping section)
...
**Read reference:** `$CLAUDE_PLUGIN_ROOT/libraries/web-section-architecture.md`
...
**Read references:**
- `$CLAUDE_PLUGIN_ROOT/libraries/web-section-copywriting.md`
...
**Read reference:** `$CLAUDE_PLUGIN_ROOT/libraries/web-brief-validation.md`  *(`mode=web`)*
...
**`mode=storyboard` only:** read `$CLAUDE_PLUGIN_ROOT/libraries/storyboard-brief-validation.md` **instead of** `web-brief-validation.md`, not in addition to it. It restates all four layers against the storyboard-brief schema and then adds a fifth print group — poster count within 3-5, per-section minimum heights, poster font-size minimums, safe-area margins, and contiguous poster sequence numbering. The substitution is load-bearing, not tidiness — the web layers fail four CRITICAL checks on a sound storyboard brief and would rewrite it into web shape; `storyboard-brief-validation.md` opens with the full rationale.
...
| **web-section-architecture.md** | 2, 5 | Arc-to-section mapping, decomposition rules, section_theme alternation |
| **web-section-copywriting.md** | 6 | Web headline hierarchy, CTA copy patterns, number plays |
| **04-image-prompts.md** | 6 | Web image formats, hero bg+overlay pattern, stock vs AI guidance |
| **web-brief-validation.md** | 9 | *(`mode=web`)* Four-layer validation framework |
...
| **storyboard-brief-validation.md** | 9 | *(`mode=storyboard`)* Replaces web-brief-validation.md — all four layers against the storyboard schema, plus print-specific checks and poster font-size minimums |
