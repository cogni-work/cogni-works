...
3. **Browse everything available** by pasting `/plugin` and pressing Enter — a menu shows every plugin in the marketplace with a short description. Install others as you need them (cogni-narrative, cogni-sales, cogni-trends, cogni-knowledge, cogni-consult, cogni-workspace, cogni-marketing, cogni-website).
