...
- **Insight summaries** (arc_id frontmatter, structured narrative): The existing process applies directly — the narrative is already distilled by the `narrative` skill.
