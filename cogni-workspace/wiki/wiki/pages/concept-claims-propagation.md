...
2. **Verify in cogni-claims.** The `cogni-workspace:claims` skill walks unverified claims, fetches the cited source, and detects deviations between the claim text and what the source actually says. Verdicts: verified / deviated / resolved (see [[concept-claim-lifecycle]]).
