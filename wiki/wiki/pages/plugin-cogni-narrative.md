...
Story arc engine for the insight-wave ecosystem. Transforms structured research and portfolio output into executive-grade narratives using 11 arc frameworks (Corporate Visions, JTBD Portfolio, Strategic Foresight, Trend Panorama + 7 more) and 8 narrative techniques. Bilingual EN/DE.
...
Corporate Visions Why Change, Jobs-to-be-Done Portfolio, Strategic Foresight, Trend Panorama, plus seven more. Each arc is a structural template — sequence of sections with required content blocks and recommended techniques.
