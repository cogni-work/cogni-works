...
This dashboard is the fourth instance of the design-variables pattern documented at `${CLAUDE_PLUGIN_ROOT}/references/design-variables-pattern.md`, alongside `portfolio-dashboard`, `trends-dashboard`, and `marketing-dashboard`. The 3-stage flow is identical: pick-theme → LLM derives design-variables.json → Python generator consumes JSON.
