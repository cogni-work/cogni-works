...
Shared language resolution pattern for all cogni-trends skills. Defines how skills detect and apply language settings for user interaction and deliverable output.
...
- **Status/navigation skills** (trends-resume, trends-dashboard): Do NOT ask — use the project language if available, otherwise the interaction language
