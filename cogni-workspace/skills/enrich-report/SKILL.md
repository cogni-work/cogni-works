...
Scan the entire report and produce an `infographic-brief.md` following the story-to-infographic v1.2 schema (see `cogni-workspace/libraries/EXAMPLE_ECONOMIST_BRIEF.md` for format reference):
