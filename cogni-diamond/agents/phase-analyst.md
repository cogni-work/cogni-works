...
description: |
  ...
  Use proactively when the diamond-resume skill needs a thorough assessment
...
tools:
  ...
  - Grep
whenToUse: |
  Use this agent when the diamond-resume or phase transition skills need a detailed
...
1. Read `diamond-project.json` for engagement context and phase state
