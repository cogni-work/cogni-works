...
> Analyzed domains: domain1.com, developers.domain1.com, docs.domain1.com
```
...
Group categories under their dimension headers (`## 1. Payment Services`, etc.).
...
### Target Segments
SMB, Mid-Market, Enterprise, Tier-1 Financial Institutions

### Deployment Options
Multi-tenant SaaS, Single-tenant, Hybrid, On-premises (regulated environments)

### Platform Ecosystem
- **Card Networks:** Visa, Mastercard, Amex, UnionPay
- **Banking Partners:** Sponsor banks, correspondent banks, central bank connectivity
- **Cloud Providers:** AWS, Azure, GCP
- **Core Banking:** Temenos, Finastra, FIS, Thought Machine
...
| **Pricing Model** | How the capability is priced (included, add-on, transaction-fee, usage-based) |
| **Availability** | GA, beta, early access, announced |
| **Partners** | Key technology partnerships for this capability |
| **Segments** | Target customer segments (SMB, mid-market, enterprise, tier-1 FI) |
