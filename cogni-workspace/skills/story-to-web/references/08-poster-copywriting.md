...
Define copywriting rules for storyboard poster text. Storyboard posters reuse web copywriting conventions (from `web-section-copywriting.md`) with print-specific adaptations. Each poster is viewed from 1-2 meters at executive walkthroughs.

**Key principle:** The skill reads `web-section-copywriting.md` for base web copywriting rules. This file defines ONLY the print-specific overrides and additions.
