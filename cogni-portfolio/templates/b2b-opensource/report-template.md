...
> Analyzed domains: domain.com, docs.domain.com, github.com/{org}
> Primary OSS project: <project-name> (license: <license-type>)
```
...
| Name | Description | Domain | Link | USP | Edition | Pricing Model | Availability | Partners | Segments | Horizon |
|------|-------------|--------|------|-----|---------|---------------|--------------|----------|----------|---------|
| <offerings...> |
```

Group categories under their dimension headers (`## 1. Open Source Projects`, etc.).
...
### Target Segments
Individual Developers, Startups, SMB, Mid-Market, Enterprise, Regulated Industries

### Deployment Models
SaaS (vendor-hosted), Self-hosted (customer-managed), Hybrid (split control/data), Marketplace (cloud provider billing)

### Community Health Indicators
- **GitHub Stars:** <count>
- **Contributors:** <count> (<% non-employee>)
- **Downloads/Month:** <count>
- **Foundation Status:** <CNCF/ASF/LF status>

### Partner Ecosystem
- **Cloud Providers:** AWS, Azure, GCP
- **Technology Partners:** (provider-specific)
- **SI Partners:** (provider-specific)
```
...
| **Domain** | Source domain where discovered (website, GitHub, marketplace) |
| **Link** | Direct URL to the capability page |
| **USP** | Unique selling proposition / differentiators |
| **Edition** | Which edition includes this (Community, Enterprise, Cloud) |
| **Pricing Model** | How the capability is priced (free/OSS, included in subscription, add-on, usage-based) |
