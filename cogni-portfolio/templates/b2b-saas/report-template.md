...
> Analyzed domains: domain1.com, developers.domain1.com, marketplace.domain1.com
```
...
Group categories under their dimension headers (`## 1. Core Platform`, etc.).
...
- **Enterprise Software:** SAP, Salesforce, ServiceNow, Oracle
